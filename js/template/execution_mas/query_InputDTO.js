...
@Data
@ApiModel(value = "Query${firstUpperCamelName}InputDTO", description = "查询${table.name}信息入参")
public class Query${firstUpperCamelName}InputDTO extends WinRpcQueryRequest {
${attrText}
}
    `
    return template
